Feature: Tapering meditation length upwards gracefully
  When someone is beginning in a meditative path, it can feel difficult at first to meditate for long periods of time at once. This feature offers a method of tapering meditation lengths upwards so that you may build up to whatever your target is gradually.
  ...
  Background:
    ...
    # this can be anything from apple notes to Trello, it doesn't really matter as long as you're comfortable using it.
